...
import { Session } from "next-auth"; // depends on how your session type is
import { FaEdit, FaTrashAlt, FaEye, FaEyeSlash } from "react-icons/fa";

/** Your types here or import them */
import { Project, Material, EditMaterialData } from "@/app/types/materialsPageTypes";
            ...
            <div key={material.id} className="rounded bg-white p-4 shadow">
              ...
              {showMaterialDetails[material.id] && (
                <div className="mt-4 space-y-1 text-sm text-gray-600">
                  ...
                  {material.costPerUnit !== undefined && (
                    <p>
                      Cost/Unit: $
                      {(material.costPerUnit ?? 0).toLocaleString(undefined, {
                  ...
                  {material.supplierName && <p>Supplier: {material.supplierName}</p>}
              ...
              {editableMaterialId === material.id && (
                ...
                >
                  ...
                  <textarea
                    name="supplierContact"
                    value={editMaterialData[material.id]?.supplierContact || ""}
                    onChange={(e) => handleMaterialChange(e, material.id)}
                    placeholder="Supplier Contact"
                    className="w-full rounded border px-4 py-2"
                  />
