...
import { validateName, validatePhoneNumber, validateImage } from "@/app/libs/validations";
...
export async function POST(request: Request) {
  ...
  if (!session) {
    ...
    try {
      ...
      const { lastName, firstName, nickname, birthday, phonenumber, location, image } = body;
      ...
      if (!lastName) {
        ...
        throw {
          code: 400,
          message: "Invalid last name format. It should contain only letters and spaces.",
        };
      }
      ...
      if (!firstName) {
        ...
        throw {
          code: 400,
          message: "Invalid first name format. It should contain only letters and spaces.",
        };
      }
      ...
      if (!nickname) {
        ...
        throw {
          code: 400,
          message: "Invalid nickname format. It should contain only letters and spaces.",
        };
      }
      ...
      if (!birthday) {
        ...
        if (selectedDate.getFullYear() < 1900 || selectedDate >= today) {
          throw {
            code: 400,
            message: "Invalid birthday. It should be between 1900 and the current date.",
          };
        }
      }
...
export async function PATCH(request: Request) {
  ...
  if (!session) {
    ...
    try {
      const body = await request.json();
      const { id, lastName, firstName, nickname, birthday, phonenumber, location, image } = body;
