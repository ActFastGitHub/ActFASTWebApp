          ...
          <div className="space-y-4">
            ...
            {isAdmin && (
              <section className="rounded-2xl bg-white p-4 shadow sm:p-5">
                ...
                <p className="mb-3 text-sm text-slate-600">
                  Enter only the project name. The system will copy{" "}
                  <span className="font-medium">{PROJECT_TEMPLATE_PATH}</span>{" "}
            ...
            <section className="rounded-2xl bg-white p-4 shadow sm:p-5">
              ...
              {!selectedProjectPath ? (
                ...
                <>
                  <div className="mb-3 rounded-xl bg-slate-100 p-3 text-sm">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {getBreadcrumbItems().map((item, index) => (
                        <button
                          ...
                          className="rounded-lg bg-white px-2 py-1 text-xs font-medium text-slate-700 ring-1 ring-slate-200 hover:bg-blue-50"
                        >
                          {index > 0 ? "/ " : ""}
                          {item.label}
                        </button>
                  ...
                  <div className="pointer-events-none absolute inset-0 flex flex-col justify-between p-3">
                    <div className="pointer-events-auto flex items-start justify-between gap-2">
                      ...
                      <button
                        ...
                        className="rounded-full bg-black/60 px-4 py-2 text-sm font-semibold text-white backdrop-blur disabled:opacity-50"
                      >
                        {torchOn ? "⚡ On" : "⚡ Flash"}
                      </button>
                    </div>
                    <div className="pointer-events-auto mx-auto mb-3 flex max-w-full flex-wrap justify-center gap-2 rounded-full bg-black/50 px-3 py-2 backdrop-blur">
              ...
              >
                {!cameraActive ? (
                  ...
                  <button
                    ...
                    className="rounded-xl bg-blue-600 px-5 py-3 font-medium text-white hover:bg-blue-700 disabled:bg-slate-400"
                  >
                    {isQueueFull ? "Queue Full" : "● Take Photo"}
                  </button>
                )}
