...
//                   })
//                   .then((res) => {
//                     console.log("Global materials result:", res.data.materials);
//                     // Optionally: set global results into state and render them
//                   });
...
//                   })
//                   .then((res) => {
//                     console.log("Global subs result:", res.data.subcontractors);
//                   });
...
//                   })
//                   .then((res) => {
//                     console.log("Global labor result:", res.data.laborCosts);
//                   });
//               }
//             }}
//           />
...
const ProjectCostManagement = () => {
  ...
  const [globalSubcontractors, setGlobalSubcontractors] = useState<
    Subcontractor[]
  >([]);
  const [globalLabor, setGlobalLabor] = useState<LaborCost[]>([]);
