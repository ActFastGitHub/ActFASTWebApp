...
// 				<Navbar />
// 				<div className='flex'>
// 					<div className={`fixed inset-y-0 left-0 bg-gray-800 text-white w-64 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out`}>
// 						<div className='p-4'>
...
// 							<button onClick={toggleSidebar} className='bg-blue-500 text-white px-4 py-2 rounded mb-4'>
// 								Toggle Sidebar
// 							</button>
...
// 								</Link>
// 								<Link href='#'>
// 									<div className='block bg-green-500 hover:bg-green-600 text-white p-4 rounded-lg shadow-lg transition duration-200 ease-in-out'>
// 										<div className='flex items-center'>
// 											<div className='mr-4'>
// 												<svg
// 													xmlns='http://www.w3.org/2000/svg'
	...
	return (
		session?.user.isNewUser === false && (
			<div className='relative bg-gray-100'>
				...
				<div className='flex'>
					<div
						className={`fixed inset-y-0 left-0 bg-gray-800 text-white w-32 sm:w-48 transform ${
					...
					<div className={`flex-1 transition-all duration-300 ${sidebarOpen ? "ml-32 sm:ml-48" : "ml-0"}`}>
						<main className='pt-24 p-6'>
							<button onClick={toggleSidebar} className='bg-blue-500 text-white px-4 py-2 rounded mb-4'>
								Toggle Sidebar
							</button>
